...
namespace LR7
{
    class Program
    {
        ...
        {
            Console.WriteLine("Лабораторная работа №7 \nВыполнила Гусева Мария студентка группы 6101-020302");
            Tasks task = null;
            while(true)
            {
                
                Console.WriteLine("Главное меню:\n0 - Выход из программы\nВведите последовательность выполнения заданий через пробел:\n" +
                    "1 - Класс ArrayVector\n2 - Класс LinkedListVector\n3 - Класс Vectors\n4 - Работа с массивом векторов типа IVectorable");
                string user_choice = Console.ReadLine();
                string[] sequence = user_choice.Split(' ', ',', '.','?','/');
                ...
                { 
                    Console.WriteLine("Введено неверный пункт меню!.");
                }
            }
        }
        static void Task1()
            ...
            while (true)
            {
                ...
                switch (menu)
                {
                    ...
                    case "11":
                        ...
                        Console.WriteLine($"Сравнение векторов с помощью метода Equals() (если векторы равны по размеру и значениям, возвращает true)" +
                            $": {vector.Equals(clone)}");
                        Console.WriteLine($"Для дополнительной проверки удалим из клона первый и последний символы");
                        clone.DeleteFromEnd();
                        clone.DeleteFromStart();
                        Console.WriteLine("Оригинал вектора: " + vector.ToString());
                        Console.WriteLine("Копия вектора: " + clone.ToString());
                        Console.WriteLine();
                        Console.WriteLine("Нажмите Enter, чтобы продолжить.");
